...
data.raw["recipe"]["dirty-water-to-water"].ingredients = { {type="fluid", name="water", amount=50}, }
data.raw["recipe"]["dirty-water-to-water-2"].ingredients = {  {type="fluid", name="water", amount=500}, }
